...
/// <summary>
/// Provides functionality for managing locale-related operations, including retrieving browser
/// locales, managing user-preferred cultures, and obtaining the browser's time zone.
/// </summary>
/// <remarks>
/// This service interacts with a JavaScript module to perform locale-related operations, such as
/// retrieving browser locales and managing user preferences. It also allows applying a culture to
/// the current thread and optionally persisting it in local storage. The service implements <see
/// cref="IAsyncDisposable"/> to ensure proper disposal of the JavaScript module reference.
/// </remarks>
/// <remarks>Initializes a new instance of the <see cref="LocaleService"/> class.</remarks>
...
public class LocaleService(IJSRuntime js) : ILocaleService, IAsyncDisposable
{
	...
	/// </summary>
	/// <remarks>
	/// This method sets a browser cookie to store the specified culture, enabling culture-specific
	/// behavior in Blazor applications. The culture name must be a valid culture identifier.
	/// </remarks>
