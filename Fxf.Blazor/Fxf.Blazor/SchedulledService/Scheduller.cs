...
/// <summary>
/// Provides a background scheduled service for periodic localization and translation updates. Uses
/// a timer to trigger translation operations at configurable intervals.
/// </summary>
/// <remarks>
/// The scheduler loads configuration from the <c>Localization</c> section, and periodically invokes
/// <see cref="IUITranslationService.RunAsync"/> to update translations. It supports dependency
/// injection for translation and language services, and ensures only one operation runs at a time.
/// </remarks>
/// <remarks>Initializes a new instance of the <see cref="Scheduller"/> class.</remarks>
