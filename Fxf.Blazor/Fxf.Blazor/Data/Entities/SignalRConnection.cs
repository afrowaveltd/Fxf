...
/// <summary>
/// Represents a log entry for a SignalR connection, used to track connection times, user identity,
/// and hub activity. Enables calculation of active time for different users, especially for
/// authenticated sessions.
/// </summary>
public class SignalRConnection
{
	/// <summary>
	/// Gets the total active time for this connection, if disconnected; otherwise, the duration
	/// since connection.
	/// </summary>
	...
	/// </summary>
	public HubType Hub { get; set; } = HubType.Index;
