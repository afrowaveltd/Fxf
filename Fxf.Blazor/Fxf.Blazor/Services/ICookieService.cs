...
/// </summary>
/// <remarks>
/// Implementations typically interact with the current HTTP context to manage cookies. This is intended for
/// server-side scenarios (e.g., ASP.NET Core/Blazor Server) where an <c>HttpContext</c> is available and may not
/// be applicable to Blazor WebAssembly.
/// </remarks>
public interface ICookieService
{
	...
	/// <param name="expireTime">The expiration time in minutes. Use <c>0</c> to apply the service's default.</param>
	/// <returns>
	/// The existing cookie value if found; otherwise, the provided value that was set.
	/// </returns>
