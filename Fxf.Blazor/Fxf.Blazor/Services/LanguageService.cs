...
/// <summary>
/// Provides language and localization utilities, including language metadata, translation file management, and dictionary operations for the application.
/// </summary>
public class LanguageService(IConfiguration configuration) : ILanguageService
{
	...
	/// <summary>
	/// Gets the names of all supported languages, sorted alphabetically.
	/// </summary>
	...
	/// <summary>
	/// Determines if the specified language code is a right-to-left (RTL) language.
	/// </summary>
	/// <param name="code">The ISO code of the language.</param>
	...
	/// </summary>
	/// <param name="code">The language code to search for. Cannot be null, empty, or whitespace.</param>
	/// <returns>A <see cref="Response{Language}"/> containing the language if found, or an error message if not.</returns>
	...
	/// <summary>
	/// Gets the list of required languages based on the presence of locale files.
	/// </summary>
	/// <param name="isFrontend">If true, checks client locales; otherwise, server locales.</param>
	/// <returns>A <see cref="Response{T}"/> with the required languages or an error message, where T is <c>List&lt;Language&gt;</c>.</returns>
	...
	/// <summary>
	/// Gets detailed information for a list of language codes.
	/// </summary>
	/// <param name="languages">A list of language codes.</param>
	/// <returns>A <see cref="Response{T}" /> where T is <c>List&lt;Language&gt;</c> with language details for each code.</returns>
	...
	/// </summary>
	/// <param name="code">A two-character locale code (e.g., "en" for English or "fr" for French).</param>
	/// <param name="isFrontend">If true, uses the client locales directory; otherwise, the server locales directory.</param>
	/// <returns>A <see cref="Response{T}"/> where T is <c>Dictionary&lt;string, string&gt;</c>, containing the dictionary if successful, or an error message.</returns>
	...
	/// </summary>
	/// <param name="isFrontend">If true, uses the client translation path; otherwise, the server translation path.</param>
	/// <returns>A <see cref="Response{T}"/> where T is <c>Dictionary&lt;string, string&gt;</c>, containing the last stored dictionary or an error message.</returns>
	...
	/// </summary>
	/// <param name="isFrontend">If true, uses the client locales directory; otherwise, the server locales directory.</param>
	/// <returns>A <see cref="Response{TranslationTree}"/> containing all translations or an error message.</returns>
...
#pragma warning disable CS1584 // Komentář XML má syntakticky nesprávný atribut cref.
#pragma warning disable CS1658 // Varování přepisuje chybu.

	/// <summary>
	/// Asynchronously saves a translation dictionary to a JSON file for the specified language code.
	/// </summary>
	/// <param name="code">The two-character language code.</param>
	/// <param name="data">The dictionary of translations to save.</param>
	/// <param name="isFrontend">If true, saves to the client locales directory; otherwise, the server locales directory.</param>
	/// <returns>A <see cref="Response{bool}"/> indicating success or failure.</returns>
	public async Task<Response<bool>> SaveDictionaryAsync(string code, Dictionary<string, string> data, bool isFrontend = false)
#pragma warning restore CS1658 // Varování přepisuje chybu.
#pragma warning restore CS1584 // Komentář XML má syntakticky nesprávný atribut cref.
	{
		try
		{
			if(code == null)
...
#pragma warning disable CS1658 // Varování přepisuje chybu.
	...
	/// <summary>
	/// Asynchronously saves the provided translation dictionary as the last stored translation in a temporary file.
	/// </summary>
	/// <param name="data">The dictionary of translations to save.</param>
	/// <param name="isFrontend">If true, saves to the client translation path; otherwise, the server translation path.</param>
	/// <returns>A <see cref="Response{bool}"/> indicating success or failure.</returns>
...
#pragma warning restore CS1584 // Komentář XML má syntakticky nesprávný atribut cref.
	...
	/// <summary>
	/// Asynchronously saves all translation dictionaries in a <see cref="TranslationTree"/>.
	/// </summary>
	/// <param name="translationTree">The translation tree containing all language dictionaries.</param>
	/// <param name="isFrontend">If true, saves to the client locales directory; otherwise, the server locales directory.</param>
	/// <returns>A <see cref="Response{T}"/> indicating success for each language, where T is <c>Dictionary&lt;string, bool&gt;</c>.</returns>
	...
	/// <summary>
	/// Gets the list of language codes for which translation files are present.
	/// </summary>
	/// <param name="isFrontend">If true, checks client locales; otherwise, server locales.</param>
	/// <returns>An array of language codes as strings.</returns>
