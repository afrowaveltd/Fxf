...
/// <summary>
/// Defines operations for language metadata and localization dictionary management. Provides
/// methods to query supported languages, load and save locale JSON files, and perform helper
/// operations such as RTL checks and discovery of available locales.
/// </summary>
public interface ILanguageService
{
	...
	/// </param>
	/// <returns>
	/// A <see cref="Response{T}"/> containing a <see cref="TranslationTree"/> with translations per language.
	/// </returns>
	...
	/// code. Unknown codes may be returned as placeholder <see cref="Language"/> objects.
	/// </returns>
	...
	/// </param>
	/// <returns>
	/// A <see cref="Response{T}"/> with a per-language success map (key = language code, value = success).
	/// </returns>
