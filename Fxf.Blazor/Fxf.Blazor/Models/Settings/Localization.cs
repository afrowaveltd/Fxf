...
public class Localization
{
	...
	/// </summary>
	/// <remarks>
	/// Set this property to control how long old log files are kept. Log files older than the
	/// specified number of days may be deleted during maintenance or cleanup operations. Adjust this
	/// value based on your application's retention and compliance requirements.
	/// </remarks>
